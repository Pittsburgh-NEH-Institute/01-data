...
![exist-db CI](https://github.com/djbpitt/01-data/workflows/exist-db%20CI/badge.svg)
...
1.  Download  the `01-data-1.0.0.xar` file from GitHub [releases](https://github.com/djbpitt/01-data/releases) page.

2.  Open the [dashboard](http://localhost:8080/exist/apps/dashboard/index.html) of your eXist-db instance and click on `package manager`.

    1.  Click on the `add package` symbol in the upper left corner and select the `.xar` file you just downloaded.

3.  You have successfully installed 01-data into exist.
...
If you see `BUILD SUCCESSFUL` ant has generated a `01-data-1.0.0.xar` file in the `build/` folder. To install it, follow the instructions [above](#installation).
...
[release-url]: https://github.com/djbpitt/01-data/releases/latest
